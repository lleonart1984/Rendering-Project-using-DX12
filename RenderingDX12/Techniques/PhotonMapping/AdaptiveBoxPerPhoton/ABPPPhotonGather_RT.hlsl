...
#ifndef VERTICES_REG
#define VERTICES_REG				t4
#endif

#ifndef MATERIALS_REG
#define MATERIALS_REG				t5
#endif

#ifndef GBUFFER_POSITIONS_REG
#define GBUFFER_POSITIONS_REG		t6
#endif

#ifndef GBUFFER_NORMALS_REG
#define GBUFFER_NORMALS_REG			t7
#endif

#ifndef GBUFFER_COORDINATES_REG
#define GBUFFER_COORDINATES_REG		t8
#endif

#ifndef GBUFFER_MATERIALS_REG
#define GBUFFER_MATERIALS_REG		t9
#endif

#ifndef LIGHTVIEW_POSITIONS_REG
#define LIGHTVIEW_POSITIONS_REG		t10
#endif
...
void PhotonGatheringAnyHit(inout PhotonRayPayload payload, in PhotonHitAttributes attr) {
	...
	if (distance(surfelPosition, p.Position) < radius)
