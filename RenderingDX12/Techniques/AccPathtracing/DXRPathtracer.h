...
struct DXRPathtracer : public Technique, public IHasScene, public IHasLight, public IHasCamera {
public:
...
#define MAX_NUMBER_OF_PHOTONS (DISPATCH_RAYS_DIMENSION*DISPATCH_RAYS_DIMENSION*3)
	...
	struct DXR_PT_Pipeline : public RTPipelineManager {
		...
		class DXR_RT_IL : public DXIL_Library<DXR_PT_Pipeline> {
			void Setup() {
				_ gLoad DXIL(ShaderLoader::FromFile(".\\Techniques\\AccPathtracing\\AccPathtracer_RT.cso"));
