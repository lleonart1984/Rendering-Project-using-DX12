...
protected:
    void Setup() {
        _ gSet InputLayout({});
        _ gSet VertexShader(ShaderLoader::FromFile(".\\Techniques\\Raymarching\\RaymarchRT\\Shaders\\RT_InitialRays_VS.cso"));
        _ gSet PixelShader(ShaderLoader::FromFile(".\\Techniques\\Raymarching\\RaymarchRT\\Shaders\\RT_InitialRays_PS.cso"));
        _ gSet DepthTest();
    }
...
protected:
    void Setup() {
        ...
        _ gSet PixelShader(ShaderLoader::FromFile(".\\Techniques\\Raymarching\\RaymarchRT\\Shaders\\RT_InitialRayDirections_PS.cso"));
    }
...
protected:
    void Setup() {
        ShowTexturePipeline::Setup();
        _ gSet PixelShader(ShaderLoader::FromFile(".\\Techniques\\Raymarching\\RaymarchRT\\Shaders\\RT_Bounce_PS.cso"));
        _ gSet AllRenderTargets(1, DXGI_FORMAT_B8G8R8X8_UNORM_SRGB);
        _ gSet IndependentBlend(true);
        //_ gSet AlphaToCoverage(true);
        //_ gSet BlendSampleMask(0);
		_ gSet BlendAtRenderTarget(0, true, D3D12_BLEND_OP_ADD, D3D12_BLEND_ONE, D3D12_BLEND_ONE);
    }
...
protected:
    ...
    void Graphics(gObj<GraphicsManager> manager) {
        ...
        manager gClear RT(render_target, float4(0));
