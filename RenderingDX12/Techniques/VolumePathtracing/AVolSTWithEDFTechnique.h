...
struct AVolSTWithEDFTechnique : public Technique, public IHasScene, public IHasLight, public IHasCamera, public IHasScatteringEvents, public IHasAccumulative {
public:

	~AVolSTWithEDFTechnique() {
	}

	struct Voxelizer : public ComputePipelineBindings {
		void Setup() {
			_ gSet ComputeShader(ShaderLoader::FromFile(".\\Techniques\\VolumePathtracing\\EGrid_Voxelization_CS.cso"));
		}
	...
	struct InitialDistances : public ComputePipelineBindings {
		void Setup() {
			_ gSet ComputeShader(ShaderLoader::FromFile(".\\Techniques\\VolumePathtracing\\EGrid_InitialDistances_CS.cso"));
		}
	...
	struct Spreading : public ComputePipelineBindings {
		void Setup() {
			_ gSet ComputeShader(ShaderLoader::FromFile(".\\Techniques\\VolumePathtracing\\EGrid_Spread_CS.cso"));
		}
	...
	struct DXR_PT_Pipeline : public RTPipelineManager {
		...
		class DXR_RT_IL : public DXIL_Library<DXR_PT_Pipeline> {
			void Setup() {
				_ gLoad DXIL(ShaderLoader::FromFile(".\\Techniques\\VolumePathtracing\\AVolSTWithEDF_RT.cso"));
