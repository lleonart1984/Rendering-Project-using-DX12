...
class DirectLightingTechnique : public Technique, public IHasScene, public IHasLight, public IHasCamera {
public:
	...
	struct DeferredDirectLightingCS : public ComputePipelineBindings {
		void Setup() {
			_ gSet ComputeShader(ShaderLoader::FromFile(".\\Techniques\\CommonRT\\DeferredDirectLighting_CS.cso"));
		}
